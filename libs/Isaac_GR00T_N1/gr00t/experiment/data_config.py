...
class RobocasaSinglePandaGripperDataConfig(BaseDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
...
class DexmgBimanualPandaGripperDataConfig(BaseDataConfig):
    video_keys = [
        "video.right_wrist_view",
        "video.left_wrist_view",
        "video.front_view",
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                ...
                normalization_modes={
                    "state.right_arm_eef_pos": "min_max",
                    "state.right_arm_eef_quat": "min_max",
                    "state.right_gripper_qpos": "min_max",
                    "state.left_arm_eef_pos": "min_max",
                    "state.left_arm_eef_quat": "min_max",
                    "state.left_gripper_qpos": "min_max",
                },
                target_rotations={
                    "state.right_arm_eef_quat": "rotation_6d",
            ...
            StateActionTransform(
                ...
                normalization_modes={
                    ...
                    "action.right_arm_eef_rot": "min_max",
                    "action.right_gripper_close": "binary",
                    "action.left_arm_eef_pos": "min_max",
                    "action.left_arm_eef_rot": "min_max",
                    "action.left_gripper_close": "binary",
                },
            ),
            # concat transforms
...
class DexmgBimanualPandaHandDataConfig(BaseDataConfig):
    video_keys = [
        "video.right_wrist_view",
        "video.left_wrist_view",
        "video.ego_view",
        ...
        transforms = [
            ...
            StateActionTransform(
                ...
                normalization_modes={
                    "state.right_arm_eef_pos": "min_max",
                    "state.right_arm_eef_quat": "min_max",
                    "state.right_hand_12d": "min_max",
                    "state.left_arm_eef_pos": "min_max",
                    "state.left_arm_eef_quat": "min_max",
                    "state.left_hand_12d": "min_max",
                },
                target_rotations={
                    "state.right_arm_eef_quat": "rotation_6d",
                    "state.left_arm_eef_quat": "rotation_6d",
...
class SimplerEnvBridgeDataConfig(BaseDataConfig):
    """Data config for SimplerEnv Bridge dataset (WidowX robot).

    Dataset: IPEC-COMMUNITY/bridge_orig_lerobot
    Modality JSON keys: state {x,y,z,roll,pitch,yaw,pad,gripper}, action {x,y,z,roll,pitch,yaw,gripper}, video {image_0}
    """
...
class SimplerEnvFractalDataConfig(BaseDataConfig):
    """Data config for SimplerEnv Fractal dataset (Google Robot).

    Dataset: IPEC-COMMUNITY/fractal20220817_data_lerobot
    Modality JSON keys: state {x,y,z,rx,ry,rz,rw,gripper}, action {x,y,z,roll,pitch,yaw,gripper}, video {image}
    """
...
class DexmgGr1ArmsOnlyDataConfig(BaseDataConfig):
    video_keys = ["video.ego_view"]
    state_keys = [
        "state.robot0_right_eef_pos",
        "state.robot0_right_eef_quat",
        "state.robot0_left_eef_pos",
        "state.robot0_left_eef_quat",
        "state.robot0_right_gripper_qpos",
        "state.robot0_left_gripper_qpos",
    ]
    action_keys = [
        "action.right_arm",
        "action.left_arm",
...
DATA_CONFIG_MAP: Dict[str, BaseDataConfig] = {
    ...
    "robocasa_single_panda_gripper": RobocasaSinglePandaGripperDataConfig(),
    "so101": So101DataConfig(),
    'dexmg_bimanual_panda_gripper': DexmgBimanualPandaGripperDataConfig(),
    'dexmg_bimanual_panda_hand': DexmgBimanualPandaHandDataConfig(),
    'dexmg_gr1_arms_only': DexmgGr1ArmsOnlyDataConfig(),
    # SimplerEnv datasets
