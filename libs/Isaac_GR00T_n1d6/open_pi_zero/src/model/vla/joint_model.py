...
from ACG.libs.Isaac_GR00T_n1d6.open_pi_zero.src.model.vla.mixture import Mixture
...
def forward_mixture_attn(
    ...
    if recorder is not None and len(post_attn_skip_names) > 0:
        recorder(attn_weights)
