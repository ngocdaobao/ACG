...
# Configure headless rendering before importing SimplerEnv/SAPIEN.
...
def _safe_image_or_zeros(env, obs, image_size):
    try:
...
class GoogleFractalEnv(gym.Env):
    ...
    def _process_observation(self, obs):
        img = _safe_image_or_zeros(self.env, obs, self.image_size)
