...
def modify_guidance(guidance, model):
    if guidance == "acg":
        from guidance.acg_pizero import apply_acg_to_pizero
        return apply_acg_to_pizero(model)
    elif guidance == "cfg":
        from guidance.cfg_pizero import apply_cfg_to_pizero
        return apply_cfg_to_pizero(model)
    elif guidance == "wng":
        from guidance.white_noise_pizero import apply_white_noise_to_pizero
        return apply_white_noise_to_pizero(model)
...
def main(args):
    ...
    if args.guidance is not None:
        model = modify_guidance(args.guidance, model)
    model.eval()
