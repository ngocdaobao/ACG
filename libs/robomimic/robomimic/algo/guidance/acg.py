...
from Issac_GROOT_N1.gr00t.model.action_head.flow_matching_action_head import FlowmatchingActionHead
from Issac_GROOT_N1.gr00t.model.gr00t_n1 import GR00T_N1
from Issac_GROOT_N1.gr00t.model.policy import Gr00tPolicy, squeeze_dict_values, unsqueeze_dict_values
from Issac_GROOT_n1d6.gr00t.model.gr00t_n1d6.gr00t_n1d6 import GR00T_N1d6, Gr00tN1d6ActionHead
from Issac_GROOT_n1d6.gr00t.policy.gr00t_policy import Gr00tPolicy as Gr00tPolicy_N1d6
...
class GR00T_N1d6_ACG(GR00T_N1d6):
    def get_action(
        self,
        inputs: dict,
        scale: float = 3.0,
